...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::Post('club-point-user-affiliate','ClubPointController@club_point_user_affiliate')->name('club_point_user_affiliate');
    Route::Post('club_point_user_review','ClubPointController@club_point_user_review')->name('club_point_user_review');
