...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::get('/affiliate/payment','AffiliateController@user_payment')->name('affiliate.payment');
    Route::post('/affiliate/payment_user','AffiliateController@payment_user')->name('affiliate.payment_user');
...
Route::post('/affiliate/new','AffiliateController@store_affiliate_new')->name('affiliate.new');
...
Route::post('/affiliate-code/store', 'AffiliateController@code_custome')->name('affiliate.code_store');
