...
<body style="margin: 0;">
    ...
    <div style="background-color: white; text-align: center; width: 85%; margin-left: auto; margin-right: auto;">
        <h2 style="font-size: 28px; padding-top: 20px;">PEMBAYARAN BERHASIL</h2>
        <p class="text" style="text-align: left; font-size: 26px; padding-top: 30px; padding-bottom: 50px;">Hi {{ $order->user->name }} {{ $order->user->last_name }},<br><br>
            Terima kasih sudah berbelanja! Kami sudah menerima dan mengkonfirmasi pembayaran kamu. Tim Phoebe akan mengirimkan pesanan kamu ke tempatmu :)</p>
        <div class="container" style="background-color: #FDF9F0; border: 1px solid #F3795C; border-radius: 10px; padding: 5px 40px; text-align: left;">
            ...
            <p class="text" style="font-size: 26px; font-weight: 600;"><span style="width: 30%; display: inline-block; font-weight: 500;">Status Pembayaran</span>: Pembayaran Diterima</p>
        ...
        <p class="text-footer" style="font-size: 22px; text-align: center; padding-top: 20px; padding-bottom: 20px;">Terima kasih atas kepercayaan kamu berbelanja di Ponny Beaute, Phoebe harap<br>
            pengalaman berbelanja kamu menyenangkan. Have a day!<br><br>
