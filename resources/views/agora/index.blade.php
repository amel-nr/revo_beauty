...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('agora/assets/common.css') }}" />
</head>
<body class="agora-theme">
  ...
  <script src="{{ asset('agora/vendor/jquery.min.js') }}"></script>
  <script src="{{ asset('agora/vendor/materialize.min.js') }}"></script>
  ...
  <script>
    ...
    function handleEvents (rtc) {
      ...
      rtc.client.on("client-role-changed", function (e){
        console.log('role');
        console.log(e);
      });
    }
