...
@section('content')
    ...
    <div class="tab-base">
        ...
        <ul class="nav nav-tabs">
            <li class="active">
                <a data-toggle="tab" href="#demo-lft-tab-1" aria-expanded="true">{{ __('Slider Utama') }}</a>
            </li>
            {{--<li class="">
                <a data-toggle="tab" href="#demo-lft-tab-2" aria-expanded="false">{{ __('Banner Beranda 1') }}</a>
            </li>--}}
            {{--<li class="">
                <a data-toggle="tab" href="#demo-lft-tab-4" aria-expanded="false">{{ __('Kategori Beranda') }}</a>
            </li>--}}
            {{--<li class="">
                <a data-toggle="tab" href="#demo-lft-tab-3" aria-expanded="false">{{ __('Banner Beranda 2') }}</a>
            </li>--}}
            {{--<li class="">
                <a data-toggle="tab" href="#demo-lft-tab-5" aria-expanded="false">{{ __('Top 10') }}</a>
            </li>--}}
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-6" aria-expanded="false">{{ __('Local Pride') }}</a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-7" aria-expanded="false">{{ __('Shop Sale') }}</a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-7" aria-expanded="false">{{ __('Banner Affiliate') }}</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            <div id="demo-lft-tab-1" class="tab-pane fade active in">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_slider()" class="btn btn-rounded btn-info pull-right">{{__('Tambah Slider')}}</a>
                    </div>
                </div>
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{__('Slider Utama')}}</h3>
                    </div>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a onclick="confirm_modal('{{route('sliders.destroy', $slider->id)}}');">{{__('Hapus')}}</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div id="demo-lft-tab-2" class="tab-pane fade">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_banner_1()" class="btn btn-rounded btn-info pull-right">{{__('Tambah Banner')}}</a>
                    </div>
                </div>
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{__('Banner Beranda')}} (Maks 3 ditampilkan)</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
                            ...
                            <tbody>
                                @foreach(\App\Banner::where('position', 1)->get() as $key => $banner)
                                    <tr>
                                        ...
                                        <td>{{ __('Posisi Banner ') }}{{ $banner->position }}</td>
                                        <td><label class="switch">
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a onclick="edit_home_banner_1({{ $banner->id }})">{{__('Ubah')}}</a></li>
                                                    <li><a onclick="confirm_modal('{{route('home_banners.destroy', $banner->id)}}');">{{__('Hapus')}}</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div id="demo-lft-tab-3" class="tab-pane fade">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_banner_2()" class="btn btn-rounded btn-info pull-right">{{__('Tambah Banner')}}</a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a onclick="edit_home_banner_2({{ $banner->id }})">{{__('Ubah')}}</a></li>
                                                    <li><a onclick="confirm_modal('{{route('home_banners.destroy', $banner->id)}}');">{{__('Hapus')}}</a></li>
                                                </ul>
                                            </div>
                                        </td>
            ...
            <div id="demo-lft-tab-4" class="tab-pane fade">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_home_category()" class="btn btn-rounded btn-info pull-right">{{__('Tambah Kategori')}}</a>
                    </div>
                </div>
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{__('Kategori Beranda')}}</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a onclick="edit_home_category({{ $home_category->id }})">{{__('Ubah')}}</a></li>
                                                        <li><a onclick="confirm_modal('{{route('home_categories.destroy', $home_category->id)}}');">{{__('Hapus')}}</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
            ...
            <div id="demo-lft-tab-5" class="tab-pane fade">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{__('Informasi Top 10')}}</h3>
                    </div>
                    ...
                    <form class="form-horizontal" action="{{ route('top_10_settings.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-sm-3" for="url">{{__('Top Kategori (Maks 10)')}}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3" for="url">{{__('Top Brand (Maks 10)')}}</label>
                                <div class="col-sm-9">
            ...
            <div id="demo-lft-tab-6" class="tab-pane fade">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{__('Banner Local Pride')}}</h3>
                    </div>

                    <!--Horizontal Form-->
                    <!--===================================================-->
                    <form class="form-horizontal" action="{{route('local_pride_banner_settings')}}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-sm-3" for="local-pride-banner">{{__('Banner Saat Ini')}}</label>
                                <div class="col-sm-9">
                                @php($banner = \App\Banner::where("url",'#localpride')->first())
                                    <input type="file" class="dropify" name="photo[]" id="local-pride-banner" data-default-file="{{ $banner ? asset($banner->photo) : asset('frontend/images/placeholder.jpg') }}" data-max-file-size="0.5M" data-allowed-file-extensions="jpg png jpeg">
                                </div>
                            </div>
                        </div>
                        <div class="panel-footer text-right">
            ...
            <div id="demo-lft-tab-7" class="tab-pane fade">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{__('Banner Shop Sale ')}}</h3>
                    </div>

                    <!--Horizontal Form-->
                    <!--===================================================-->
                    <form class="form-horizontal" id="form-shopsale-banner" action="{{route('shopsale.banner')}}" method="POST" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-sm-3" for="shop-sale">{{__('Banner Saat Ini')}}</label>
                                <div class="col-sm-9">
                                @php($banner = \App\Banner::where("url",'#shopsale')->get())
                                @foreach($banner as $key => $value)
                                    <input type="file" class="dropify" name="shopsale_banner[]" id="shop-sale" data-default-file="{{ $value->photo ? asset($value->photo) : asset('frontend/images/placeholder.jpg') }}" data-max-file-size="0.5M" data-allowed-file-extensions="jpg png jpeg">
                                    <input type="hidden" name="id_banner[]" value="{{$value->id}}">
                                @endforeach
                                </div>
                            </div>
                        </div>
