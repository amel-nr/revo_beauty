...
<div class="row">
    <form class="form form-horizontal mar-top" action="{{ route('pointproduct.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
        @csrf
                    ...
                    <div class="tab-content">
                        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
                            ...
                            {{--<div class="form-group" id="size">
                                <label class="col-lg-2 control-label">{{__('Ukuran')}}</label>
                                <div class="col-lg-7">
                                    <select class="form-control demo-select2-placeholder" name="size" id="size">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <input type="number" class="form-control" min="0" name="point" placeholder="Nilai poin produk" required>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $('#product_id').on('change',function(){
        ...
        $.post('{{ url('products/detailFordata') }}', { _token:'{{ csrf_token() }}', id:id }, function(data){
            var _data =JSON.parse(data.choice_options);
            console.log(_data);
        });
    });
