...
<div class="panel">
    <div class="panel-heading bord-btm clearfix pad-all h-100">
        <h3 class="panel-title pull-left pad-no">{{__('Ulasan Produk')}}</h3>
                ...
                <div class="box-inline pad-rgt pull-left">
                    <div class="select" style="min-width: 300px;">
                        <select class="form-control demo-select2" name="rating" id="rating" onchange="filter_by_rating()">
                            <option value="">{{__('Urutkan berdasarkan Rating')}}</option>
                            <option value="rating,desc">{{__('Rating (Tinggi > Rendah)')}}</option>
                            <option value="rating,asc">{{__('Rating (Rendah > Tinggi)')}}</option>
                        </select>
                    </div>
                </div>
            </form>
