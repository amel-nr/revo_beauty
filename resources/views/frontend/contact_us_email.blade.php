        ...
        <div class="row">
            ...
            <div class="col-8">
                <div class="row py-5">
                    ...
                    <div class="col-md-4 col-12 pl-5 col-contact-us col-contact-us-detail"
                        style="border: #f3795c solid 1px; background-color: #fcf8F0; border-radius: 4px; width: 70%;">
                        ...
                        <p style="font-size: 16px;"><a href="mailto:marketing@ponnybeaute.com"
                                style="font-weight: 500; color: black;">marketing@ponnybeaute.com</a></p>
                        ...
                        <p style="font-size: 16px;"><a href="mailto:cs@ponnybeaute.com"
                                style="font-weight: 500; color: black;">cs@ponnybeaute.com</a></p>
                    </div>
                    <div class="col-md-8 col-12">
                        <h4 style="font-weight: 700;">HUBUNGI KAMI</h4>
                        <p class="text-justify" style="font-weight: 500; font-size: 16px;">Kami selalu menerima masukanmu
                            dengan senang hati. Agar
                        ...
                        <form action="/sendEmail" method="POST">
                            ...
                            <div>
                                <input type="text" name="name" id="name" class="form-control"
                                    value="{{ Auth::check() ? Auth::user()->name : '' }}" placeholder="Nama"
                                    style="background-color: #fcf8F0; border-color: #f3795c;" required>
                            </div>
                            <div class="pt-3">
                            ...
                            <div class="pt-3">
                                ...
                                <select class="custom-select" id="perihal"
                                    style="border-color:#F3795C;background-color:#FCF8F0 !important;">
                            ...
                            <div class="pt-3">
                                <textarea class="form-control" name="text" id="teks" placeholder="Pesan"
                                    style="background-color: #fcf8F0; border-color: #f3795c;" rows="7" required></textarea>
                            </div>
                        </form>
                        <button type="submit" id="komplain"
                            class="btn btn-danger text-center btn-mskkeranjang font-weight-bold py-2 px-5 mt-4">Komplain</button>
                    </div>
                </div>
            </div>
            <div class="col-2"></div>
