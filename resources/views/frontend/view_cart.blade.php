                            ...
                            <div class="container pt-3 px-4">
                                <div class="row" style="border-bottom: 1px solid #F3795C;">
                                    ...
                                    <div class="col-md-10 col-6">
                                        ...
                                        <div class="text-right pb-3">
                                            <a href="#" onclick="removeSampleFromTukarPoin(event, {{ isset($value->id) ? $value->id : 0  }});" type="button"><i class="fa fa-trash-o" aria-hidden="true" style="font-size: 26px; color: #F3795C;"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container pt-3 px-4">
                            <div class="row" style="border-bottom: 1px solid #F3795C;">
                                ...
                                <div class="col-md-10 col-6">
                                    ...
                                    <div class="text-right pb-3">
                                        <a href="#" onclick="removeSampleFromCartView(event, {{ isset($value->id) ? $value->id : 0 }});" type="button"><i class="fa fa-trash-o" aria-hidden="true" style="font-size: 26px; color: #F3795C;"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
