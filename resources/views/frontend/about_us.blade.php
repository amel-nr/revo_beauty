...
<section style="background-color: #fcf8F0;">
    <div style="background: #FACAC3 url({{ asset('frontend/images/atribut.png') }}) no-repeat center center; background-size: cover; padding: 180px 0;">
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-md-4 col-12" style="border-right: 1px solid #f3795c;">
                <h4 class="mb-4" style="font-weight: bold;">TENTANG PONNY BEAUTE</h4>
                <a href="#" class="button-tentang-ponny about-ponny-button" style="color: #f3795c;"><p class="mb-0 py-3" style="font-size: 20px; font-weight: 600; border-bottom: 1px solid #f3795c;">Apa itu Ponny Beaute</p></a>
                <a href="#" class="button-tentang-ponny our-promise-button" style="color: black;"><p class="mb-0 py-3" style="font-size: 20px; font-weight: 600;">Keunggulan Kami</p></a>
            </div>
