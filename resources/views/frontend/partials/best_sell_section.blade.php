            ...
            <div class="carousel-item {{ $key==0 ? 'active' : ''}}">
                <div class="row">
                    ...
                    <div class="col-3 align-items-center justify-content-center">
                        ...
                        @php
                            $total = 0;
                            $total += $product->reviews != null ? $product->reviews->count():0;
                        @endphp
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="hidden" class="rating rating-product" data-filled="fa fa-heart custom-heart" data-empty="fa fa-heart custom-heart-empty" value="{{$product->rating}}" disabled="disabled" style="color: #FFAAA5;"/>
                                    </td>
                                    <td>({{ $total }})</td>
                                </tr>        
                                </tbody>
...
<div class="col-1 p-0 align-items-center justify-content-center product-slider"><a  href="#carouselExampleIndicators" data-slide="next">
    <div class="carousel-nav-icon">
...
<div class="col-1 p-0 align-items-center justify-content-center product-slider-mobile"><a  href="#carouselExampleIndicatorsMobile" data-slide="next">
    <div class="carousel-nav-icon">
