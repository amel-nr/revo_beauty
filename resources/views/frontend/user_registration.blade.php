                ...
                <div class="row">
                    ...
                    <div class="row" style="margin-top: 20px;">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <input type="text"
                                    class="form-control" name="last_name" id="" aria-describedby="helpId" placeholder="Nama Belakang" style="padding: 10px; border-color: #F3795C;" required>
                            </div>
                        </div>
                    </div>
                    <div class="input-group mb-3">
                        ...
                        <input type="text"
                            class="form-control" name="phone"  aria-describedby="helpId" placeholder="Nomor Handphone" id="phone_num" style="padding: 10px; border-color: #F3795C;"  value="{{ str_replace('+62','',$nomor_hp) }}" readonly>
                    </div>
