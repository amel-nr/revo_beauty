        ...
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                <div class="dash-widget-vertical">
                    <div class="rorate">{{__('PRODUK')}}</div>
                </div>
                <div class="pad-ver mar-top text-main">
                    <i class="demo-pli-data-settings icon-4x"></i>
                </div>
                <br>
                <p class="text-lg text-main">{{__('Total produk yang ditampilkan')}}: <span class="text-bold">{{ \App\Product::where('published', 1)->get()->count() }}</span></p>
                ...
                @endif--}}
                <p class="text-lg text-main">{{__('Total produk yang dimasukkan')}}: <span class="text-bold">{{ \App\Product::where('published', 1)->where('added_by', 'admin')->get()->count() }}</span></p>
                <br>
                <a href="{{ route('products.admin') }}" class="btn btn-primary mar-top">Atur Produk <i class="fa fa-long-arrow-right"></i></a>
            </div>
        </div>
    </div>
    <div class="col-md-6">
            ...
            <div class="col-sm-6">
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        <p class="text-normal text-main">{{__('Total kategori produk')}}</p>
                        <p class="text-semibold text-3x text-main">{{ \App\Category::all()->count() }}</p>
                        <a href="{{ route('categories.create') }}" class="btn btn-primary mar-top btn-block top-border-radius-no">{{__('Tambah Kategori')}}</a>
                    </div>
                </div>
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        <p class="text-normal text-main">{{__('Total sub sub kategori produk')}}</p>
                        <p class="text-semibold text-3x text-main">{{ \App\SubSubCategory::all()->count() }}</p>
                        <a href="{{ route('subsubcategories.create') }}" class="btn btn-primary mar-top btn-block top-border-radius-no">{{__('Tambah Sub Sub Kategori')}}</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        <p class="text-normal text-main">{{__('Total sub kategori produk')}}</p>
                        <p class="text-semibold text-3x text-main">{{ \App\SubCategory::all()->count() }}</p>
                        <a href="{{ route('subcategories.create') }}" class="btn btn-primary mar-top btn-block top-border-radius-no">{{__('Tambah Sub Kategori')}}</a>
                    </div>
                </div>
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        <p class="text-normal text-main">{{__('Total brand produk')}}</p>
                        <p class="text-semibold text-3x text-main">{{ \App\Brand::all()->count() }}</p>
                        <a href="{{ route('brands.create') }}" class="btn btn-primary mar-top btn-block top-border-radius-no">{{__('Tambah Brand')}}</a>
                    </div>
                </div>
            </div>
        </div>
...
@if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
    ...
    <div class="col-md-6">
        <div class="panel">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">{{__('Penjualan produk berdasarkan kategori')}}</h3>
            </div>
    ...
    <div class="col-md-6">
        <div class="panel">
            <!--Panel heading-->
            <div class="panel-heading">
                <h3 class="panel-title">{{__('Stok produk berdasarkan kategori')}}</h3>
            </div>
    ...
    <div class="col-md-6">
        <div class="panel">
            <div class="panel-body text-center dash-widget pad-no">
                ...
                <br>
                <p class="text-3x text-main bg-primary pad-ver">{{__('Pengaturan')}} <strong>{{__('Tampilan')}}</strong></p>
                <br>
                <br>
                <br>
                <br>
            ...
            <div class="col-sm-6">
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <br>
                        <a href="{{ route('home_settings.index') }}" class="btn btn-primary mar-top btn-block top-border-radius-no">{{__('Klik Disini')}}</a>
                    </div>
                </div>
                {{--<div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <br>
                        <a href="{{route('privacypolicy.index', 'privacy_policy')}}" class="btn btn-primary mar-top btn-block top-border-radius-no">{{__('Klik Disini')}}</a>
                    </div>
                </div>--}}
            </div>
            <div class="col-sm-6">
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <br>
                        <a href="{{route('generalsettings.index')}}" class="btn btn-primary mar-top btn-block top-border-radius-no">{{__('Klik Disini')}}</a>
                    </div>
                </div>
                {{--<div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <br>
                        <a href="{{route('links.index')}}" class="btn btn-primary mar-top btn-block top-border-radius-no">{{__('Klik Disini')}}</a>
                    </div>
                </div>--}}
            </div>
        </div>
