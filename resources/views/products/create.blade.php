				...
				<div class="tab-base tab-stacked-left">
				    ...
				    <ul class="nav nav-tabs">
				       ...
				       {{-- <li class="">
						...
						<li class="">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-7" aria-expanded="false">{{__('Penaggunaan')}}</a>
				        </li>
						<li class="">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-8" aria-expanded="false">{{__('Rekomendasi')}}</a>
				        </li>
						{{-- <li class="">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-9" aria-expanded="false">Display Settings</a>
				        </li> --}}
						{{--<li class="">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-10" aria-expanded="false">{{__('Informasi Pengiriman')}}</a>
				        </li>--}}
						{{--<li class="">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-11" aria-expanded="false">{{__('PDF Specification')}}</a>
				        </li>--}}
				    </ul>
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="name" placeholder="{{__('Nama Produk')}}" onchange="update_sku()" required>
								</div>
							</div>
							<div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Tagline')}}</label>
	                            <div class="col-lg-7">
	                                <input type="text" class="form-control" name="tagline" placeholder="{{__('Tagline')}}">
	                            </div>
	                        </div>
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="unit" placeholder="Satuan (contoh: KG, Pc, dll)" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Tag')}}</label>
								<div class="col-lg-7">
									<input type="text" class="form-control" name="tags[]" placeholder="Ketik tag" data-role="tagsinput">
								</div>
							</div>
							@php
				        ...
				        <div id="demo-stk-lft-tab-3" class="tab-pane fade">
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Penyedia Layanan Video')}}</label>
								<div class="col-lg-7">
						...
						<div id="demo-stk-lft-tab-7" class="tab-pane fade">
							 <div class="form-group">
	                            ...
	                            <div class="col-lg-9">
	                                <input type="text" name="nomer_bpom" class="form-control" />
	                            </div>
	                        </div>
	                        <div class="form-group" style="display: none;">
	                            <label class="col-lg-2 control-label">{{__('Ukuran dan satuan ukuran')}}</label>
	                            <div class="col-lg-9">
	                                <input type="text" name="satuan_ukuran" class="form-control" />
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            ...
	                            <div class="col-lg-9">
	                            	<div id="bahan-input">
	                            		 <input type="text" data-role="tagsinput" name="bahan_aktif"class="form-control" />
	                            	</div>
	                            </div>
	                        </div>
							<div class="form-group">
	                            ...
	                            <div class="col-lg-9">
	                                <textarea class="editor" name="komposisi"></textarea>
	                            </div>
	                        </div>
							<div class="form-group">
							...
							<div class="form-group">
	                            ...
	                            <div class="col-lg-9">
	                                <textarea class="editor" name="penggunaan"></textarea>
	                            </div>
	                        </div>
				        </div>
						...
						<div id="demo-stk-lft-tab-8" class="tab-pane fade">
							<div class="form-group" style="width:500px;">
								<label class="col-sm-2 control-label" for="recommendation">{{__('Rekomendasi Produk')}}</label>
								<div class="col-sm-10">
