	...
	<form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
		...
		<div class="panel">
			<div class="panel-heading">
				<h3 class="panel-title">{{__('Informasi Produk')}}</h3>
			</div>
			<div class="panel-body">
				<div class="tab-base tab-stacked-left">
				    ...
				    <ul class="nav nav-tabs">
						<li class="active">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-1" aria-expanded="true">{{__('Umum')}}</a>
				        </li>
				        <li class="">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-2" aria-expanded="false">{{__('Gambar')}}</a>
				        </li>
						{{--<li class="">
				       ...
				       {{-- <li class="">
						...
						<li class="">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-5" aria-expanded="false">{{__('Varian')}}</a>
				        </li>
						<li class="">
				            <a data-toggle="tab" href="#demo-stk-lft-tab-6" aria-expanded="false">{{__('Harga')}}</a>
				        </li>
						<li class="">
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							<div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Nama Produk')}}</label>
	                            <div class="col-lg-7">
	                                <input type="text" class="form-control" name="name" placeholder="{{__('Nama Produk')}}" value="{{$product->name}}" required>
	                            </div>
							</div>
							<div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Tagline')}}</label>
	                            <div class="col-lg-7">
	                                <input type="text" class="form-control" name="tagline" placeholder="{{__('Tagline')}}" value="{{$product->tagline}}">
	                            </div>
	                        </div>
	                        <div class="form-group" id="category">
	                            <label class="col-lg-2 control-label">{{__('Kategori')}}</label>
	                            <div class="col-lg-7">
	                        ...
	                        <div class="form-group" id="subcategory">
	                            <label class="col-lg-2 control-label">{{__('Sub Kategori')}}</label>
	                            <div class="col-lg-7">
	                        ...
	                        <div class="form-group" id="subsubcategory">
	                            <label class="col-lg-2 control-label">{{__('Sub Sub Kategori')}}</label>
	                            <div class="col-lg-7">
	                        ...
	                        <div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Satuan')}}</label>
	                            <div class="col-lg-7">
	                                <input type="text" class="form-control" name="unit" placeholder="Satuan (contoh: KG, Pc, dll)" value="{{$product->unit}}" required>
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Tag')}}</label>
	                            <div class="col-lg-7">
	                                <input type="text" class="form-control" name="tags[]" id="tags" value="{{ $product->tags }}" placeholder="Ketik tag" data-role="tagsinput">
	                            </div>
	                        </div>
							@php
							...
							@if ($refund_request_addon != null && $refund_request_addon->activated == 1)
								<div class="form-group" style="display: none;">
									<label class="col-lg-2 control-label">{{__('Dapat Dikembalikan')}}</label>
									<div class="col-lg-7">
							...
							@endif
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Produk Spesial')}}</label>
								<div class="col-lg-7">
									<label class="switch" style="margin-top:5px;">
										<input type="checkbox" name="is_special" @if ($product->is_special == 1) checked @endif>
			                            <span class="slider round"></span></label>
									</label>
								</div>
							</div>
				        ...
				        <div id="demo-stk-lft-tab-2" class="tab-pane fade">
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Gambar Utama')}} <small><br>(Harus diisi untuk muncul di quick view)</small></label>
								<div class="col-lg-7">
									<div id="photos">
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Gambar Thumbnail')}} <small>(290x300)</small></label>
								<div class="col-lg-7">
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Flash Sale')}} <small>(290x300)</small></label>
								<div class="col-lg-7">
						...
						<div id="demo-stk-lft-tab-5" class="tab-pane fade">
							<div class="form-group" style="display: none;">
								<div class="col-lg-2">
									<input type="text" class="form-control" value="{{__('Warna')}}" disabled>
								</div>
								<div class="col-lg-7">
							...
							<div class="form-group">
								<div class="col-lg-2">
									<input type="text" class="form-control" value="{{__('Atribut Produk')}}" disabled>
								</div>
			                    <div class="col-lg-7">
			                        <select name="choice_attributes[]" id="choice_attributes" class="form-control demo-select2" multiple data-placeholder="Pilih Atribut">
							...
							<div class="">
								<p>Pilih atribut produk kemudian masukkan nilai pada setiap atribut</p>
								<br>
							</div>
						...
						<div id="demo-stk-lft-tab-6" class="tab-pane fade">
							<div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Harga')}}</label>
	                            <div class="col-lg-7">
	                        ...
	                        <div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Pajak')}}</label>
	                            <div class="col-lg-7">
	                            ...
	                            <div class="col-lg-1">
	                                <select class="demo-select2" name="tax_type" required>
	                                	<option value="amount" <?php if($product->tax_type == 'amount') echo "selected";?> >Rp</option>
	                                	<option value="percent" <?php if($product->tax_type == 'percent') echo "selected";?> >%</option>
	                                </select>
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Diskon')}}</label>
	                            <div class="col-lg-7">
	                            ...
	                            <div class="col-lg-1">
	                                <select class="demo-select2" name="discount_type" required>
	                                	<option value="amount" <?php if($product->discount_type == 'amount') echo "selected";?> >Rp</option>
						...
						<div id="demo-stk-lft-tab-7" class="tab-pane fade">
	                        ...
	                        <div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Nomer BPOM')}}</label>
	                            <div class="col-lg-9">
	                                <input type="text" name="nomer_bpom" class="form-control" value="{{ $product->nomer_bpom }}" />
	                            </div>
	                        </div>
	                        <div class="form-group" style="display: none;">
	                            <label class="col-lg-2 control-label">{{__('Ukuran dan satuan ukuran')}}</label>
	                            <div class="col-lg-9">
	                                <input type="text" name="satuan_ukuran" class="form-control" value="{{  $product->satuan_ukuran }}" />
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Bahan Aktif')}}</label>
	                            <div class="col-lg-9">
	                                <input type="text" name="bahan_aktif"class="form-control" data-role="tagsinput" value="{{ $product->bahan_aktif }}" />
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Komposisi')}}</label>
	                            <div class="col-lg-9">
	                                <textarea class="editor" name="komposisi">{{$product->komposisi}}</textarea>
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Keterangan')}}</label>
	                            <div class="col-lg-9">
	                                <textarea class="editor" name="description">{{$product->description}}</textarea>
	                            </div>
							</div>
							<div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Cara Penggunaan')}}</label>
	                            <div class="col-lg-9">
	                                <textarea class="editor" name="penggunaan">{{$product->penggunaan}}</textarea>
	                            </div>
	                        </div>
				        </div>
			...
			<div class="panel-footer text-right">
				<button type="submit" name="button" class="btn btn-purple">{{ __('Simpan') }}</button>
			</div>
		</div>
	</form>
</div>
