            ...
            $(".card-flip").each(function () {
                ...
                $this.flip({
                    ...
                    trigger: $this.data("flip-trigger") ?
                        $this.data("flip-trigger") : "hover",
                    reverse: $this.data("flip-reverse") ?
                        $this.data("flip-reverse") : false,
                });
            });
        });
    }
        ...
        $(".countdown").each(function () {
            ...
            $this.countdown(date).on("update.countdown", function (event) {
                var $this = $(this).html(
                    event.strftime(
                        "" +
                        '<div class="countdown-item"><span class="countdown-digit" style="background-color: #F3795C;">%-D</span><span class="countdown-label countdown-days">day%!d</span></div>' +
                        '<div class="countdown-item"><span class="countdown-digit" style="background-color: #F3795C;">%H</span><span class="countdown-separator">:</span><span class="countdown-label">hr</span></div>' +
                        '<div class="countdown-item"><span class="countdown-digit" style="background-color: #F3795C;">%M</span><span class="countdown-separator">:</span><span class="countdown-label">min</span></div>' +
                        '<div class="countdown-item"><span class="countdown-digit" style="background-color: #F3795C;">%S</span><span class="countdown-label">sec</span></div>'
                    )
                );
            });
        });
