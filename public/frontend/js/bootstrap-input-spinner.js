...
(function ($) {
    ...
    $.fn.inputSpinner = function (methodOrOptions) {
        ...
        var html =
            ...
            config.buttonsWidth +
            '" class="btn btn-decrement text-center ' +
            config.buttonsClass +
            '" type="button">' +
            ...
            config.textAlign +
            '; color: black !important; border: 1px solid #F3795C; background-color: #FCF8F0; padding: 0px !important;" class="form-control"/>' +
        ...
        this.each(function () {
                    ...
                    autoDelayHandler = setTimeout(function () {
                        autoIntervalHandler = setInterval(function () {
                            if (boostStepsCount > config.boostThreshold) {
                                if (autoMultiplier) {
                                    calcStep(
                                        step * parseInt(boostMultiplier, 10)
                                    );
            ...
            function updateAttributes() {
                ...
                var inputClass = originalClass.replace(
                ...
                var newDecimals =
                    parseInt($original.attr("data-decimals")) || 0;
            ...
            function parseLocaleNumber(stringNumber) {
                ...
                var thousandSeparator = numberFormat
                    .format(1111)
                    .replace(/1/g, "");
